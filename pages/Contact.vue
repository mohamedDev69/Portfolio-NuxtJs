...
onMounted(() => {
  animateIcon("#icon-github", 400);
  animateIcon("#icon-linkedin", 600);
  animateIcon("#icon-mail", 800);
...
<template>
  ...
  <div class="container">
    ...
    <section class="2xl:mt-20 xl:mt-0 sm:mt-16 mt-6 flex lg:flex-row flex-col lg:gap-5 gap-10 items-center ">
    ...
    <footer class="sm:pb-10 pb-14 2xl:mt-44 lg:mt-16 sm:mt-32 mt-24">
      <div class="flex justify-center items-center">
        <a id="icon-github" href="https://github.com/mohamedDev69" target="_blank" class="opacity-0 text-gold-200 2xl:w-[4(px] w-[40px] hover:text-white mr-16 ">
        ...
        <a  id="icon-linkedin" href="https://www.linkedin.com/in/mohamed-chettah/" target="_blank" class="opacity-0 text-gold-200 2xl:w-[35px] w-[30px] hover:text-white mr-16 ">
        ...
        <a id="icon-mail" href="mailto:mohamedchettah@gmail.com" class="opacity-0 text-gold-200 2xl:w-[44px] w-[39px] hover:text-white ">
