      ...
      <div class="2xl:mt-32 xl:mt-8">
        <div class="flex xl:justify-between xl:flex-row justify-center flex-col 2xl:mx-0 mx-4">
          ...
          <div class="flex xl:justify-start justify-center">
            <img  data-aos="fade-left" data-aos-duration="1000"  class="relative md:mt-10 mt-16 border-2 border-gold-200 rounded-full 2xl:w-[360px] xl:w-[300px] md:w-[310px] lg:w-[300px] w-64" src="/img/profil.jpg" alt="photo de profil"/>
          </div>
        </div>
      </div>

      <div class="flex 2xl:mt-[150px] xl:mt-[80px] mt-20 sm:pb-20 pb-36 xl:justify-normal justify-center">
        <a  data-aos="fade-up" data-aos-duration="500"  href="https://github.com/mohamedDev69" target="_blank" class="text-gold-200 w-[44px] hover:text-white mr-16 ">
        ...
        <a data-aos="fade-up" data-aos-duration="1000" href="https://www.linkedin.com/in/mohamed-chettah/" target="_blank" class="text-gold-200 w-[35px] mt-1 hover:text-white mr-16 ">
        ...
        <a  data-aos="fade-up" data-aos-duration="1500" href="mailto:mohamedchettah@gmail.com" class="text-gold-200 w-[44px] hover:text-white ">
